...
const Features = () => {
  return (
    <section id="roadmap" className="contain">
        ...
        <div 
            ...
            {
                features.map(({id, icon: Icon, title, content}, i) => (
                    <motion.article           
                        ...
                        key={id} 
                        className="group border border-white/5 p-[1.9rem] rounded-[1.15rem] bg-[#0a1d2e] hover:bg-white/5 transition">
